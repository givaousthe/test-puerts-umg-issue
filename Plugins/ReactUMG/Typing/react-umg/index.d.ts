declare module "react-umg" {
    ...
    interface TestUMGProps extends UserWidgetProps {
    }

    class TestUMG extends React.Component<TestUMGProps> {
        nativePtr: UE.TestUMG;
    }
    ...
    interface TsUMG_CProps extends UserWidgetProps {
    }

    class TsUMG_C extends React.Component<TsUMG_CProps> {
        nativePtr: UE.Game.Test.TsUMG.TsUMG_C;
    }

    interface DynamicUMG_CProps extends UserWidgetProps {
    }

    class DynamicUMG_C extends React.Component<DynamicUMG_CProps> {
        nativePtr: UE.Game.Test.DynamicUMG.DynamicUMG_C;
    }

    interface PointerToUberGraphFrame {
    }

    interface BlueprintUMG_CProps extends UserWidgetProps {
        UberGraphFrame?: PointerToUberGraphFrame;
    }

    class BlueprintUMG_C extends React.Component<BlueprintUMG_CProps> {
        nativePtr: UE.Game.Test.BlueprintUMG.BlueprintUMG_C;
    }

    interface TestTsUMG_CProps extends TestUMGProps {
        UberGraphFrame?: PointerToUberGraphFrame;
    }

    class TestTsUMG_C extends React.Component<TestTsUMG_CProps> {
        nativePtr: UE.Game.Blueprints.TypeScript.TestTsUMG.TestTsUMG_C;
    }
